...
public class Server {
        ...
        while (true) {
            try {
                ...
                if (message.startsWith("@name")) {
                    ...
                    sendKillCommand(ipAddress, port);
                } else {
    ...
    public void sendKillCommand(InetAddress clientAddress, int clientPort) throws IOException {
        String killCommand = "@kill";
        byte[] sendData = killCommand.getBytes();
